...
const FAQS: FAQItem[] = [
  {
    question: 'Lắp đặt mạng Wifi Nhà Mạng 3 Miền mất bao lâu?',
    answer:
      'Sau khi tiếp nhận yêu cầu, kỹ thuật viên Nhà Mạng 3 Miền sẽ khảo sát và triển khai lắp đặt hoàn tất trong vòng từ 12h đến tối đa 36h. Quý khách có thể chủ động hẹn khung giờ thuận tiện nhất.',
  },
  {
  ...
  {
    question: 'Modem Wi-Fi 6 của Nhà Mạng 3 Miền có gì vượt trội so với modem thế hệ cũ?',
    answer:
      'Modem Wi-Fi 6 thế hệ mới nhất của Nhà Mạng 3 Miền cung cấp tốc độ vượt trội gấp 3 lần, độ trễ giảm tới 75%, khả năng xuyên tường mạnh mẽ và chịu tải cùng lúc từ 30 đến 50 thiết bị mượt mà không bị nghẽn mạng.',
  },
  {
  ...
  {
    question: 'Nhà Mạng 3 Miền hỗ trợ xử lý sự cố kỹ thuật như thế nào?',
    answer:
      'Nhà Mạng 3 Miền cam kết dịch vụ chăm sóc khách hàng 24/7. Mọi sự cố kỹ thuật sẽ được tiếp nhận và xử lý nhanh chóng qua hotline 0819 900 530, kỹ thuật viên có mặt tại nhà hỗ trợ trong 2h - 4h.',
  },
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10">
          <h2 className="text-2xl sm:text-3xl font-black text-zinc-900 dark:text-white tracking-tight">
            Câu Hỏi Thường Gặp Khi Lắp Wifi Nhà Mạng 3 Miền
          </h2>
        </div>
